      ...
      >
        <div style={{ width: '100%', maxWidth: 420 }}>
          ...
          <p style={{ fontSize: '1rem', color: 'var(--text-secondary)', marginBottom: '1.75rem' }}>
            No credit card. No hidden fees. Just shared finance done right.
          </p>
                    ...
                    {[1, 2, 3, 4, 5].map((value) => (
                      <div
                        ...
                        style={{
                          ...
                          height: 3,
                          borderRadius: 2,
                          background: value <= strength.score ? strength.color : 'var(--hairline)',
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input
                  ...
                  onChange={(event) => field('confirmPassword', event.target.value)}
              ...
              {errors.confirmPassword && (
                <p style={{ fontSize: '0.76rem', color: 'var(--danger)', marginTop: '0.25rem' }}>{errors.confirmPassword}</p>
              )}
            </div>
